        ...
        <div className="flex flex-wrap justify-between items-center mt-10 ">
          {Object.keys(items).map((key) => {
            ...
            return (
              <div
                key={key}
                className="flex flex-col justify-around items-center w-[30%] h-[30%] mx-5 sm:w-[15%] sm:h-[15%] lg:w-[11%] lg:h-[11%] my-5 lg:my-8 rounded-full shadow-md transition-transform duration-200 ease-in-out transform hover:scale-[1.04] active:scale-[1.0] active:shadow-lg"
              >
                <button
                  key={key}
                ...
                >
                  <Image
                    ...
                    priority={true}
                  />
                  <div className="absolute inset-0 flex items-center justify-center text-[1.6rem] lg:text-[2rem] font-thin">
                    {items[key].name}
                  </div>
                </button>
              </div>

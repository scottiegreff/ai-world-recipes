    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center items-center px-6 lg:px-8">
        ...
        <button
          ...
          className="mb-3 flex w-[250px] justify-center rounded-xl border border-red-200 bg-slate-200 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600"
        >
          <FcGoogle size="25px" className="m-auto text-xl" />
        </button>
        <button
          onClick={() => signIn("github")}
          className="flex w-[250px] justify-center rounded-xl bg-slate-900 border border-red-200 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600"
        >
          <FaGithub size="25px" className="m-auto text-xl" />
        </button>

        <div className="mt-10 sm:mx-auto sm:w-full sm:w-[250px] sm:max-w-sm">
          ...
          <RedToast message="Invalid Login" show={showToastForIvalidLogin} />
        </div>
